...
const todo1 = todoFactory("Walk the dog", "Take Gabbers for a walk.", format(new Date(), 'MMM dd yyyy'));
const todo2 = todoFactory("Make dinner", "Make a pot of chili", format(new Date(), 'MMM dd yyyy'));
myTodos = [todo1, todo2];
